 ...
 * <b>ReflectionUtils</b>
 * <p>
 * This class provides useful methods which makes dealing with reflection much easier
 * <p>
...
public final class ReflectionUtils {
     ...
     */
    public static Constructor<?> getConstructor(String className, Class<?>... parameterTypes) throws NoSuchMethodException, ClassNotFoundException {
     ...
     */
    public static Object instantiateObject(String className, Object... arguments) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
        return instantiateObject(Class.forName(className), arguments);
    }
     ...
     */
    public static Object invokeMethod(Object instance, String className, String methodName, Object... arguments) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
        return invokeMethod(instance, Class.forName(className), methodName, arguments);
    }
     ...
     */
    public static Field getField(String className, boolean declared, String fieldName) throws NoSuchFieldException, SecurityException, ClassNotFoundException {
        return getField(Class.forName(className), declared, fieldName);
    }
     ...
     */
    public static Object getValue(Object instance, String className, boolean declared, String fieldName) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException, ClassNotFoundException {
        return getValue(instance, Class.forName(className), declared, fieldName);
    }
     ...
     */
    public static void setValue(Object instance, String className, boolean declared, String fieldName, Object value) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException, ClassNotFoundException {
        setValue(instance, Class.forName(className), declared, fieldName, value);
    }
    ...
    public enum DataType {
        ...
        // Initialize maps for quick class lookup
        static {
